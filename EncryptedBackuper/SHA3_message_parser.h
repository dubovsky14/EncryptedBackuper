...
namespace EncryptedBackuper {
    ...
    class SHA3_message_parser   {
        public:
            ...
            SHA3_message_parser(const std::string &input, SHA3_input_type input_type);

            /* Parse cpp_int*/
            SHA3_message_parser(const boost::multiprecision::cpp_int &input);
        ...
        private:
            ...
            static constexpr unsigned int s_output_length_bits = 576;
