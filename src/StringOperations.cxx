...
bool EncryptedBackuper::StringIsInt(const string &x)    {
    try {
        std::stoi(x);
    }
    catch (...) {
...
bool EncryptedBackuper::StringIsFloat(const string &x)   {
    try {
        std::stod(x);
    }
    catch (...) {
...
vector<string> EncryptedBackuper::SplitAndStripString(string input_string, const string &separator) {
...
vector<string> EncryptedBackuper::SplitString(string input_string, const string &separator)    {
...
std::vector<std::string> EncryptedBackuper::SplitByWhitespaces(std::string line)   {
...
void EncryptedBackuper::StripString(string *input_string, const string &chars_to_remove)    {
...
void         EncryptedBackuper::to_upper(std::string *input_string) {
    std::transform(input_string->begin(), input_string->end(),input_string->begin(), ::toupper);
};

std::string  EncryptedBackuper::to_upper_copy(const std::string &input_string)  {
    string result = input_string;
    EncryptedBackuper::to_upper(&result);
    return result;
};

// convert both strings to uppercase and compare
bool EncryptedBackuper::CompareCaseInsensitive(const std::string &x, const std::string &y)    {
    const string x_upper = EncryptedBackuper::to_upper_copy(x);
    const string y_upper = EncryptedBackuper::to_upper_copy(y);
    return x_upper == y_upper;
};

bool EncryptedBackuper::Contains(const string &main_string, const string &substring)    {
    return (main_string.find(substring)) != std::string::npos;
};

bool EncryptedBackuper::StartsWith(const string &main_string, const string &prefix)    {
...
bool EncryptedBackuper::EndsWith(const string &main_string, const string &suffix)    {
